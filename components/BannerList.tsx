  ...
  return (
    <li className="bg-gray-800 p-4 mb-5 rounded-lg shadow">
      {banner.isActive ? (
        ...
        <p className="text-perso-yellow-one font-semibold">Inactive</p>
      )}
      ...
      <button
        ...
        className="bg-perso-yellow-one text-perso-white-two px-4 py-2 rounded hover:bg-red-400 mr-2"
      >
        Supprimer
      </button>
      ...
      <button
        type="button"
        className="bg-perso-yellow-one text-perso-white-two px-4 py-2 rounded hover:bg-perso-yellow-one"
